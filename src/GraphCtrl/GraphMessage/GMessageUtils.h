...
#define CGRAPH_RECV_MPARAM_WITH_TIMEOUT(Type, topic, value, timeout)                       \
    CGraph::GMessageManagerSingleton.get()->recvTopicValue<Type>(topic, value, timeout);   \
...
#define CGRAPH_SUB_MPARAM_WITH_TIMEOUT(Type, connId, value, timeout)                       \
    CGraph::GMessageManagerSingleton.get()->subTopicValue<Type>(connId, value, timeout);   \
